      ...
      <section className="pt-28 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap mb-16">
            ...
            <a href="https://discord.gg/7jSV4x5g" target="_blank" rel="noopener noreferrer">
              <Button variant="outline" size="lg" className="h-12 px-8 text-base gap-2 border-[#5865F2]/30 bg-[#5865F2]/10 hover:bg-[#5865F2]/20 text-[#5865F2] hover:text-white font-medium transition-all">
                <DiscordIcon className="size-5" />
                Join Discord
              </Button>
            </a>
